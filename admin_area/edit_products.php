        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image1" name="product_image1" class="form-control w-90 m-auto"
                    required="required">
                <img src="./product_images\<?php echo $product_image1 ?>" alt="jjj" class="poduct_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image2" name="product_image2" class="form-control w-90 m-auto"
                    required="required">
                <img src="./product_images\<?php echo $product_image2 ?>" alt="jjj" class="poduct_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image3" name="product_image3" class="form-control w-90 m-auto"
                    required="required">
                <img src="./product_images\<?php echo $product_image3 ?>" alt="jjj" class="poduct_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
if (isset ($_POST['edit_product'])) {
    ...
    if ($product_title == '' or $product_desc == '' or $product_keywords == '' or $product_category == '' or $product_brands == '' or $product_image1 == '' or $product_image2 == ''
